...
# dr_projector = projector2d(image_size=256, 
#                         num_det=768, 
#                         pix_size=0.7433, 
#                         det_size=1.2858, 
#                         iso_source=595.0, 
...
dr_projector = projector2d(image_size=256, 
                        ...
                        det_size=0.7200, 
                        iso_source=250.0, 
                        source_detector=250.0, scan_type="arc").cuda()
...
class IterBlock(nn.Module):
    def __init__(self, hid_channels=64, kernel_size=3, padding=1):
        ...
        #     nn.ReLU(),
        # )
        # self.block2_2_1 = nn.Sequential(
        #     nn.Conv2d(hid_channels, hid_channels, kernel_size=kernel_size, padding=padding),
        #     nn.ReLU(),
        # )
        # self.block2_2_2 = nn.Sequential(
        #     nn.Conv2d(hid_channels, hid_channels, kernel_size=kernel_size, padding=padding),
        #     nn.ReLU(),
        # )
        # self.block2_2_3 = nn.Sequential(
        #     nn.Conv2d(hid_channels, hid_channels, kernel_size=kernel_size, padding=padding),
        #     nn.ReLU(),
        # )
        # self.block2_2_4 = nn.Sequential(
        #     nn.Conv2d(hid_channels, hid_channels, kernel_size=kernel_size, padding=padding),
        #     nn.ReLU(),
        # )
    ...
    def forward(self, input_data, proj, t):
        ...
        # tmp2_1 = self.block2_1(input_data)

        # tmp2_2 = self.block2_2_1(tmp2_1+t)
        # tmp2_2 = self.block2_2_2(tmp2_2+t)
        # tmp2_2 = self.block2_2_3(tmp2_2+t)
        # tmp2_2 = self.block2_2_4(tmp2_2+t)

        # tmp2_3 = self.block2_3(tmp2_2)
        # tmp2 = tmp2_3
        tmp2 = self.red_tiny(input_data, t)
...
class GaussianDiffusion(nn.Module):
    ...
    def sample(self, batch_size = 16, img=None, t=None):
        ...
        while (t):
            ...
            x1_bar = self.learn_block(x1_bar, sino, step)
    ...
    def p_losses(self, x_start, x_end, t):
        ...
        if self.train_routine == 'Final':
            ...
            sino = A(x_end, views)
            x_recon_learn = self.learn_block(x_recon, sino, t)
